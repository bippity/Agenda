...
public class Database 
{
	...
	public void checkTables() throws SQLException
	{
		...
		db = c.prepareStatement("create table if not exists Categories (ID INTEGER PRIMARY KEY, Owner TEXT, Name TEXT, TabID TEXT)");
		db.execute();
		//creates Tabs Table
		db = c.prepareStatement("create table if not exists Tabs (ID INTEGER PRIMARY KEY, Owner TEXT, Category TEXT, Info TEXT, Date STRING)");
		db.execute();
	}
